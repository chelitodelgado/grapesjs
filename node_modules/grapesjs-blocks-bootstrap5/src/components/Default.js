        ...
        traits: [
          {
            ...
            options: [
              { value: '', name: 'Default' },
              ...contexts_w_white.map((v) => ({ value: `text-${v}`, name: capitalize(v) })),
            ],
            label: 'Text color',
          },
          {
            ...
            options: [
              { value: '', name: 'Default' },
              ...contexts_w_white.map((v) => ({ value: `bg-${v}`, name: capitalize(v) })),
            ],
          ...
          },
          {
            ...
            options: [
              { value: '', name: 'Default' },
              ...contexts_w_white.map((v) => ({ value: `border border-${v}`, name: capitalize(v) })),
            ],
            label: 'Border color',
          },
          {
