        ...
        traits: [
          {
            ...
            options: [
              ...
              ...spans.map((i) => ({ value: `col-${i}`, name: `${i}/12` })),
            ],
            label: 'XS Width',
          },
          {
            ...
            options: [
              ...
              ...spans.map((i) => ({ value: `col-sm-${i}`, name: `${i}/12` })),
            ],
            label: 'SM Width',
          },
          {
            ...
            options: [
              ...
              ...spans.map((i) => ({ value: `col-md-${i}`, name: `${i}/12` })),
            ],
            label: 'MD Width',
          },
          {
            ...
            options: [
              ...
              ...spans.map((i) => ({ value: `col-lg-${i}`, name: `${i}/12` })),
            ],
            label: 'LG Width',
          },
          {
            ...
            options: [
              ...
              ...spans.map((i) => ({ value: `col-xl-${i}`, name: `${i}/12` })),
            ],
            label: 'XL Width',
          },
          {
            ...
            options: [
              { value: '', name: 'None' },
              ...spans.map((i) => ({ value: `offset-${i}`, name: `${i}/12` })),
            ],
            label: 'XS Offset',
          },
          {
            ...
            options: [
              { value: '', name: 'None' },
              ...spans.map((i) => ({ value: `offset-sm-${i}`, name: `${i}/12` })),
            ],
            label: 'SM Offset',
          },
          {
            ...
            options: [
              { value: '', name: 'None' },
              ...spans.map((i) => ({ value: `offset-md-${i}`, name: `${i}/12` })),
            ],
            label: 'MD Offset',
          },
          {
            ...
            options: [
              { value: '', name: 'None' },
              ...spans.map((i) => ({ value: `offset-lg-${i}`, name: `${i}/12` })),
            ],
            label: 'LG Offset',
          },
          {
            ...
            options: [
              { value: '', name: 'None' },
              ...spans.map((i) => ({ value: `offset-xl-${i}`, name: `${i}/12` })),
            ],
            label: 'XL Offset',
          },
